...
public class h_SearchRange {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new h_SearchRange().searchRange1(new int[]{5, 7, 7, 8, 8, 10}, 8)));
    }
    //not O(log n) at worse case where the entire array contains the target number.
